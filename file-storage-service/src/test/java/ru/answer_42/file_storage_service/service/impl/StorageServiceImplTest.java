...
import org.apache.kafka.shaded.com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponse;
...
class StorageServiceImplTest {
  ...
  void success_load_all() throws IOException {
    ...
    List<FileMetadataResponseDto> desiredFiles = List.of(fileResponseDto);
    String result = null;
  ...
  void success_store_file() {
    //When
    FileMetadataResponseDto fileMetadataResponseDto = storageService.store(USER_LOGIN,
        multipartFile);

    //Then
    assertThat(fileMetadataResponseDto).isEqualTo(fileResponseDto);
  }
